...
export const agentsCompositions = {
  email: [
    example(
      ...
      part(
        ...
        part(
          "EmailSection",
          part("EmailHeading"),
          part("EmailText", part("EmailLink"), part("EmailInlineCode")),
          part("EmailPanel", part("EmailDetailRow"), part("EmailDivider")),
          part("EmailBulletList"),
          part("EmailOneTimeCode"),
          part("EmailMarkdown"),
          part("EmailCodeBlock"),
          part("EmailButton"),
        ),
        part("EmailColumns", part("Img"), part("EmailSection")),
      ),
    ...
    example(
      ...
      part(
        "EmailFooter",
        part("EmailSocialLinks", part("EmailMutedLink")),
        part("EmailFooterLinks"),
        part("EmailCaption"),
        part("EmailAddress"),
        part("EmailUnsubscribe"),
        part("EmailFooterLegal"),
      ),
