...
export const hookEntries = [
  ...
  },
  {
    ...
    target: "components/control-ui/hooks/use-chat-input.ts",
    install: "the ChatInput component",
    source: sourceFile("Behavior hook", "src/registry/hooks/use-chat-input.ts", "hook"),
    references: [{ label: "ChatInput", href: "/ai/chat-input" }],
  },
  {
    id: "use-user-ask",
    kind: "Hook",
...
export const utilEntries = [
  ...
  },
  {
    ...
    target: "components/control-ui/chat-input-editor/serialize.ts",
    install: "the ChatInput rich editor",
    source: sourceFile("Serializer", "src/registry/sources/control-ui/chat-input-editor/serialize.ts", "util"),
    ...
    references: [
      { label: "ChatInput", href: "/ai/chat-input" },
