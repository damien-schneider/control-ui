...
export function ChatSceneExample() {
  const [message, setMessage] = useState("Can this scene compose turns?");
  ...
  return (
    <div className="p-4">
      <ChatScene className="border shadow-soft">
            ...
            <ChatMessage from="assistant" density="compact">
              <ChatMessageRow>
                <ChatMessageBody>
                  ...
                  <ChatMessageContent>Yes. The scene owns layout while message, action bar, and composer stay separate.</ChatMessageContent>
                </ChatMessageBody>
              </ChatMessageRow>
            </ChatMessage>
          </ChatTurn>
