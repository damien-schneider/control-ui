        ...
        <PopoverContent align="start">
          ...
          <div className="grid grid-cols-[1fr_auto] items-center gap-2 text-sm">
            ...
            <input
              id="popover-width"
              defaultValue="320px"
              className="h-8 w-24 rounded-[var(--radius-control)] bg-background px-2 text-right ring-1 ring-inset ring-border focus-visible:outline-(--focus-ring) focus-visible:outline-offset-(--focus-ring-offset) focus-visible:outline-(length:--focus-ring-width)"
            />
