...
export function PrimitiveInputGroupExample() {
  return (
    <div className="flex w-full max-w-sm flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        <span className="text-[11px] font-medium text-muted-foreground">asChild — the group renders as a button</span>
        <InputGroup asChild size="sm" className="cursor-pointer text-muted-foreground hover:text-foreground">
