export const REQUIRED_PAIRS = [
  ...
  {
    id: "control-text-on-control-fill-over-background",
    category: "Text surfaces",
    label: "Control text on control fill over background",
    foreground: "--foreground",
  ...
  {
    id: "control-text-on-control-fill-over-card",
    category: "Text surfaces",
    label: "Control text on control fill over card",
    foreground: "--foreground",
    background: "--control-fill",
    surface: "--card",
    threshold: 4.5,
