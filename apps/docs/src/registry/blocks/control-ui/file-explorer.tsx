          ...
          return (
            <li key={`${breadcrumb.id}:${breadcrumb.path.join("/")}`} className="flex min-w-0 items-center gap-1">
              ...
              <button
                ...
                className={cn(
                  "min-w-0 truncate rounded-[var(--radius-popup-item)] px-1 py-0.5 text-muted-foreground transition hover:bg-foreground/6 hover:text-foreground focus-visible:outline-(--focus-ring) focus-visible:outline-offset-(--focus-ring-offset) focus-visible:outline-(length:--focus-ring-width)",
