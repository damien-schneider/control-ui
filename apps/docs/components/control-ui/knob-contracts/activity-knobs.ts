// Generated from src/registry/sources/control-ui/recipes/activity.css by scripts/gen-knob-contracts.ts — run `bun run sync:knobs`.
export const activityKnobs = [
  "--cui-activity-row-foreground",
