...
import type { ChatInputEditorApi, ChatInputEditorExtension } from "../types";
...
// Pill node: atom + contenteditable=false = non-editable unit (arrows skip it); leafText serializes to "@label"; styled via chat-input-mention slot (skin-swappable).
...
export function mentionExtension<Item extends TriggerMenuItemData = TriggerMenuItemData>({
  ...
  side = "top",
  align = "start",
}: MentionExtensionConfig<Item>): ChatInputEditorExtension {
  return {
    name: "mention",
