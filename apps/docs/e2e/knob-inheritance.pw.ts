...
test("knobs set on a family root paint pseudo-elements", async ({ page }) => {
  await page.evaluate(() => {
    document.body.insertAdjacentHTML(
      "beforeend",
      `
        <div data-control-family="chat-composer" data-control-ui="chat-composer" data-slot="root" style="--chat-composer-input-placeholder-foreground: rgb(4 5 6)">
          ...
          <textarea id="composer-slot-placeholder" data-control-family="chat-composer" data-control-ui="chat-composer" data-slot="textarea" placeholder="Slot" style="--chat-composer-input-placeholder-foreground: rgb(40 50 60)"></textarea>
        </div>
        <div id="transcript-divider" data-control-family="transcript-divider" data-control-ui="transcript-divider" data-slot="root" style="--transcript-divider-line-color: rgb(13 14 15)"></div>
      `,
    );
  });
...
test("knobs set on a family root reach every descendant slot", async ({ page }) => {
  await page.evaluate(() => {
    document.body.insertAdjacentHTML(
      "beforeend",
      `
        <div data-control-family="chat-composer" data-control-ui="chat-composer" data-slot="root" style="--chat-composer-shell-background: rgb(24 25 26)">
          <div id="composer-shell" data-control-family="chat-composer" data-control-ui="chat-composer" data-slot="shell"></div>
        </div>
        <section data-control-family="chat-layout" data-control-ui="chat-layout" data-slot="root" style="--chat-layout-thought-foreground: rgb(27 28 29)">
          <button id="chat-thought" data-control-family="chat-layout" data-control-ui="chat-thought" data-slot="trigger">Thought</button>
        </section>
        <div data-control-family="code" data-control-ui="code" data-slot="root" style="--code-title-foreground: rgb(30 31 32)">
          <span id="code-title" data-control-family="code" data-control-ui="code" data-slot="title">Code</span>
        </div>
        <div data-control-family="inline-attachment" data-control-ui="inline-attachment" data-slot="root" style="--inline-attachment-content-foreground: rgb(33 34 35)">
        ...
        <article data-control-family="inline-citation" data-control-ui="inline-citation" data-slot="source" style="--inline-citation-quote-background: rgb(39 40 41); --inline-citation-quote-radius: 17px">
        ...
        <div data-control-family="task-list" data-control-ui="task-list" data-slot="root" style="--task-list-item-foreground: rgb(36 37 38)">
